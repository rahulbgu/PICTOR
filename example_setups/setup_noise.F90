...
subroutine InitPosVel
        ...
        Temp_ion=0.1_psn !in units of rest mass energy, Temp_ion=kT_i/m_ic^2 
        Temp_elc=0.1_psn*(mi/me)! Temp_elc=kT_e/m_ec^2
		        
!--------------------!!create ion-electron pairs!!-------------------------! 
         !ions: normal weight 
          do i=1,Nelc
               call GetRandomPositionHomogeneous(xlocal,ylocal,zlocal)     
               call GetVelGamma_MaxwellJuttner(0.0_psn,Temp_ion,ugamma,vgamma,wgamma)
			   call InsertNewPrtl(xlocal,ylocal,zlocal,ugamma,vgamma,wgamma,0.75_psn,0,1,0)
			   
               call GetVelGamma_MaxwellJuttner(0.0_psn,Temp_ion,ugamma,vgamma,wgamma)
			   call InsertNewPrtl(xlocal,ylocal,zlocal,ugamma,vgamma,wgamma,0.25_psn,0,1,0)
