module vars
     ...
     !----------------------------------------------------------------
	 real(dbpsn)  :: skin_depth_cm = (5.31e+5)*(sqrt(ne0))
	 real(dbpsn)  :: elc_per_prtl = (ne0*(skin_depth_cm**3))/(epc*(c_ompe**3))
	 real(dbpsn)  :: grid_spacing_cm = skin_depth_cm / c_ompe  
	 real(dbpsn)  :: E_SI = sqrt(ne0*9.2466e+03)/sqrt(epc*masse*c*c) !V/m
