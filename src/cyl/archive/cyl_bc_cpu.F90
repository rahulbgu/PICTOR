...
!---------------------------------------------------------------------------------
	...
	subroutine RefOuterBC_Prtl(rmax) !rmax must be a whole number
		...
		integer   :: ind,n
	    !rmax_local=rmax-rborders(procxind)+xmin !prtl boundary lies in the middle of the cell
		rmax_local=BC_Rmax_Prtl-rborders(procxind)+3
		ind=rmax_local
	...
	subroutine CurrentBC_Outer
		...
		!ind= BC_Rmax_Prtl-xborders(procxind)+xmin
	...
	subroutine CurrentBC_Outer1
		integer :: ind
		real(psn) :: f
		ind= BC_Rmax_Prtl-xborders(procxind)+3
		!ind= BC_Rmax_Prtl-xborders(procxind)+xmin
