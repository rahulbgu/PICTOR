module cyl_savedata_routines
 ...
 contains 
	 ...
	 subroutine CalcFldEnergy_cyl(Bfld_energy,Efld_energy)
		 ...
		 i1=3
		 if((inc_axis.eqv..true.).and.(procxind(proc).eq.0)) i1=4     
...
!subroutines to nomalised the qunaitties to per unit cell      
     subroutine NormaliseFldDensity3 
		 call NormaliseFldDensity_cyl(Jx)
		 call NormaliseFldDensity_cyl(Jy)
		 call NormaliseFldDensity_cyl(Jz)
