...
subroutine InterpVecGridPoints(x,y,z,pFx,pFy,pFz,F_x,F_y,F_z)
	real(psn) :: x,y,z
	real(psn), dimension(mx,my,mz), intent(IN) :: F_x,F_y,F_z
	real(psn), intent(inout) :: pFx,pFy,pFz
    real(psn):: dx,dy
    integer :: i,j,k
    real(psn) :: w1,w2,w3,w4
#ifndef twoD
...
end subroutine InterpVecGridPoints
