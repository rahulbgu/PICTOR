...
! Jz_gpu=Jz
   ...
   subroutine SyncCurrentEdgesGPU_Exclusive
	   call FldYZEdgeExchangeGPU(Jx,Jy,Jz,Jx_gpu,Jy_gpu,Jz_gpu)	   
	   call FldZXEdgeExchangeGPU(Jx,Jy,Jz,Jx_gpu,Jy_gpu,Jz_gpu)
#ifndef twoD  	   
	   call FldXYEdgeExchangeGPU(Jx,Jy,Jz,Jx_gpu,Jy_gpu,Jz_gpu)
#endif 
