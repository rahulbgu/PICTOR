...
integer, parameter :: nz=4!*16!no. of grid cells along z (used only if THREE_DIMS=y (3D simulation) is defined in the Makefile)
...
integer, parameter :: tfinish=200000! total number of time steps
...
integer, parameter   :: epc=32*2!number of the electrons per cell 
...
integer , parameter  :: curr_filter=0!3!no. of times the urrent filter (moving average) is applied  
...
integer            :: prtl_save_period=100000!default: spatial cordinates: x,y,z;three-velocity: u,v,w; and q(charge),flv(species type)
...
integer, parameter :: restart_save_period=1000! period to save state of the simulation  
